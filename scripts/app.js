...
function cronometro (){
    ...
    if ((minutos==0)&&(segundos==0)) {
        ...
        document.getElementById("cronometro").innerHTML =  mostrarMinutos + ":" + mostrarSegundos
        document.getElementById("comenzar").disabled = true
        manejado.innerHTML="Ha terminado el ciclo Pomodoro. Presione reiniciar para volver a comenzar."
    }
    else if (minutos>=0 ) {
        document.getElementById("cronometro").innerHTML =  mostrarMinutos + ":" + mostrarSegundos
        segundos--
...
function comenzar() {
    if (estado === "detenido") {
        intervalo = window.setInterval(cronometro,1)
